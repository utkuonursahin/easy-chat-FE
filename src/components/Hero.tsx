        ...
        <section className="col-start-2 row-start-2 flex flex-col gap-16 justify-center items-center">
            ...
            <div className="flex flex-col gap-4">
                ...
                <Button className="bg-primary w-64">
                    <a className="w-full h-full flex items-center justify-center" href="/login">Login</a>
                </Button>
                <a href="/register" className="btn btn-secondary">Don't have an account? <span
                    className="underline">Register</span></a>
            </div>
        </section>
    );
};
